...
func (cs *chatServer) publishHandler(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		http.Error(w, http.StatusText(http.StatusRequestEntityTooLarge), http.StatusRequestedRangeNotSatisfiable)
		return
	}
	cs.publish(msg)
...
// func subscribe subscribes the given WebSocket to all broadcast messages.
